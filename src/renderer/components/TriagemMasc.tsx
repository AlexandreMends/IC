...
import avatar_masc from '../../../assets/imagens/avatar-masculino-frente.png'
...
function TriagemMasc() {
  return (
    <div>
      <h1>Selecione o lugar com dor</h1>
      <img src={avatar_masc} useMap="#image-map" alt="avatar-masculino" />
      <map name="image-map">
